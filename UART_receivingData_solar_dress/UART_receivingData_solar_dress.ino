...
void loop () {
  ...
  if ( (digitalRead( 5 ) == 0) & (digitalRead( 4 ) == 0) ) {//receiving data
        ...
        if ( buf[i] == '#' ) {
          if ( buf[i+1] == '*') {
            ...
            while (  counter < 8){
              ...
              bufToSend[counter] |=in2<<4;
                bufToSend[counter] |= in1;
              counter++;
              i++;
              check = 1;
            }
  ...
  else if  ( (digitalRead( 5 ) == 1) & (digitalRead( 4 ) == 0) ) //making blocks
  {
    char code[] = { 
      B00000000,B00000000,B00000000,B00000000,B00000000,B00000000,B00000000,B00000000                       };
    for ( int i2=0;i2<8;i2++){
  ...
  else if  ( (digitalRead( 5 ) == 1) & (digitalRead( 4 ) == 1) )//running around
  {
    char code[] = { 
      B00000000,B00000000,B00000000,B00000000,B00000000,B00000000,B00000000,B00000000                                       };
